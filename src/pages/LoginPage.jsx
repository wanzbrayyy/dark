...
const LoginPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{translations.login} - RedDrak ID</title>
        <meta name="description" content={`${translations.login} to RedDrak ID`} />
      </Helmet>
        ...
        >
          <div className="glass-effect p-8 rounded-lg neon-border">
            <div className="text-center mb-8">
              ...
              />
              <h1 className="text-3xl font-bold gradient-text">{translations.login}</h1>
              <p className="text-gray-400 mt-2">Welcome back to RedDrak ID</p>
            </div>
